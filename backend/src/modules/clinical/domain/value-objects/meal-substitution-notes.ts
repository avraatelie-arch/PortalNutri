...
export class MealSubstitutionNotes {
  private constructor(private readonly section: ClinicalTextSection) {}

  static empty(): MealSubstitutionNotes {
    return new MealSubstitutionNotes(
      ClinicalTextSection.empty(MEAL_PLAN_TEXT_MAX_LENGTH),
    );
  }

  static create(raw: string | null | undefined): MealSubstitutionNotes {
    return new MealSubstitutionNotes(
