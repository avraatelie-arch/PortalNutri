...
export interface MealPlanCreationContextRequest {
  tenantId: string;
  patientId: string;
...
export interface MealPlanCreationContextErrors {
...
export class MealPlanCreationContext {
  ...
  static create(params: {
    ...
    originClinicalEncounter: ClinicalEncounterDirectoryEntry | null;
    originAnamnesis: AnamnesisDirectoryEntry | null;
  }): MealPlanCreationContext {
    return new MealPlanCreationContext(params);
  }
}

export async function buildMealPlanCreationContext(params: {
  ...
  request: MealPlanCreationContextRequest;
  errors: MealPlanCreationContextErrors;
}): Promise<MealPlanCreationContext> {
  const {
    tenantId,
    patientId,
  ...
  return MealPlanCreationContext.create({
    tenant,
    patient,
...
export async function validateActiveNutritionistForMealPlan(params: {
  nutritionistDirectory: NutritionistDirectoryPort;
  tenantId: string;
  nutritionistId: string;
  errors: Pick<
