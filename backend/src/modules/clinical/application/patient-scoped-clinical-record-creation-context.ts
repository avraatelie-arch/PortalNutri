...
export interface PatientScopedClinicalRecordCreationContextRequest {
  tenantId: string;
  patientId: string;
...
export interface PatientScopedClinicalRecordCreationContextErrors {
...
export class PatientScopedClinicalRecordCreationContext {
  ...
  static create(params: {
    ...
    return new PatientScopedClinicalRecordCreationContext(params);
  }
}

export async function buildPatientScopedClinicalRecordCreationContext(params: {
  ...
  request: PatientScopedClinicalRecordCreationContextRequest;
  errors: PatientScopedClinicalRecordCreationContextErrors;
}): Promise<PatientScopedClinicalRecordCreationContext> {
  const {
    tenantId,
    patientId,
  ...
  return PatientScopedClinicalRecordCreationContext.create({
    tenant,
    patient,
...
export async function validateActiveNutritionistForPatientScopedClinicalRecord(params: {
  nutritionistDirectory: NutritionistDirectoryPort;
  tenantId: string;
  nutritionistId: string;
  errors: Pick<
