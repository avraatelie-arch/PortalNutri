...
export interface ClinicalObjectiveCreationContextRequest {
  tenantId: string;
  patientId: string;
...
export interface ClinicalObjectiveCreationContextErrors {
...
export class ClinicalObjectiveCreationContext {
  ...
  static create(params: {
    ...
    originClinicalEncounter: ClinicalEncounterDirectoryEntry | null;
    originAnamnesis: AnamnesisDirectoryEntry | null;
  }): ClinicalObjectiveCreationContext {
    return new ClinicalObjectiveCreationContext(params);
  }
}

export async function buildClinicalObjectiveCreationContext(params: {
  ...
  request: ClinicalObjectiveCreationContextRequest;
  errors: ClinicalObjectiveCreationContextErrors;
}): Promise<ClinicalObjectiveCreationContext> {
  const {
    tenantId,
    patientId,
  ...
  return ClinicalObjectiveCreationContext.create({
    tenant,
    patient,
...
export async function validateActiveNutritionistForClinicalObjective(params: {
  nutritionistDirectory: NutritionistDirectoryPort;
  tenantId: string;
  nutritionistId: string;
  errors: Pick<
    ClinicalObjectiveCreationContextErrors,
